...
- 1️⃣ Простые запросы на естественном языке (NL → API)

<video src="docs/assets/1.mp4" controls width="720"></video>

- 2️⃣ Портфель: отчёт, бенчмарк, экспорты

<video src="docs/assets/2.mp4" controls width="720"></video>

- 3️⃣ Бэктест: пресеты и простые стратегии, метрики, графики, экспорт

<video src="docs/assets/3.mp4" controls width="720"></video>

- 4️⃣ Сканер рынка по фильтрам, спарклайны

<video src="docs/assets/4.mp4" controls width="720"></video>
